 ...
 */
static bool ParseEscaped(Parser *const parser, LCH_Buffer *const field) {
  assert(parser != NULL);
 ...
 */
static bool ParseNonEscaped(Parser *const parser, LCH_Buffer *const field) {
  assert(parser != NULL);
  assert(parser->cursor != NULL);
  assert(parser->end != NULL);
  assert(field != NULL);
 ...
 */
static LCH_Buffer *ParseField(Parser *const parser) {
  assert(parser != NULL);
  assert(parser->cursor != NULL);
  assert(parser->end != NULL);
