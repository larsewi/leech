 ...
 *          string.
 */
const LCH_Buffer *LCH_JsonStringGetString(const LCH_Json *json);
 ...
 *          of type object.
 */
const LCH_Buffer *LCH_JsonObjectGetString(const LCH_Json *json, const LCH_Buffer *key);
 ...
 *          of type object.
 */
const LCH_Json *LCH_JsonObjectGetObject(const LCH_Json *json, const LCH_Buffer *key);
 ...
 *          of type object.
 */
const LCH_Json *LCH_JsonObjectGetArray(const LCH_Json *json, const LCH_Buffer *key);
 ...
 */
bool LCH_JsonObjectSet(const LCH_Json *json, const LCH_Buffer *key, LCH_Json *value);
 ...
 * @warning This function assumes the passed JSON element is of type object.
 */
bool LCH_JsonObjectSetStringDuplicate(const LCH_Json *json, const LCH_Buffer *key,
 ...
 * @warning This function assumes the passed JSON element is of type object.
 */
LCH_Json *LCH_JsonObjectRemoveObject(const LCH_Json *json, const LCH_Buffer *key);
 ...
 * @warning This function assumes the passed JSON element is of type object.
 */
LCH_Json *LCH_JsonObjectRemoveArray(const LCH_Json *json, const LCH_Buffer *key);
 ...
 */
LCH_Json *LCH_JsonObjectKeysSetMinus(const LCH_Json *left, const LCH_Json *right);
 ...
 * @warning This function assumes both passed JSON elements are of type object.
 */
LCH_Json *LCH_JsonObjectKeysSetIntersectAndValuesSetMinus(const LCH_Json *left,
 ...
 */
bool LCH_JsonIsEqual(const LCH_Json *left, const LCH_Json *right);
