...
LCH_Instance *SetupInstance(const char *const work_dir) {
  ...
  {  // Add classes table
    ...
    LCH_TableCreateInfo createInfo = {
        ...
        .read_locator = ".leech/classes.cache",
        .write_locator = ".leech/classes.csv",
  ...
  {  // Add variables table
    LCH_TableCreateInfo createInfo = {
        ...
        .read_locator = ".leech/variables.cache",
        .write_locator = ".leech/variables.csv",
        .read_callback = LCH_TableReadCallbackCSV,
        .write_callback = LCH_TableWriteCallbackCSV,
        .insert_callback = LCH_TableInsertCallbackCSV,
        .delete_callback = LCH_TableDeleteCallbackCSV,
  ...
  {  // Add last seen hosts table
    LCH_TableCreateInfo createInfo = {
        ...
        .read_locator = ".leech/lastseen.cache",
        .write_locator = ".leech/lastseen.csv",
        .read_callback = LCH_TableReadCallbackCSV,
        .write_callback = LCH_TableWriteCallbackCSV,
        .insert_callback = LCH_TableInsertCallbackCSV,
        .delete_callback = LCH_TableDeleteCallbackCSV,
  ...
  {  // Add installed packages table
    LCH_TableCreateInfo createInfo = {
        ...
        .read_locator = ".leech/software.cache",
        .write_locator = ".leech/software.csv",
        .read_callback = LCH_TableReadCallbackCSV,
        .write_callback = LCH_TableWriteCallbackCSV,
        .insert_callback = LCH_TableInsertCallbackCSV,
        .delete_callback = LCH_TableDeleteCallbackCSV,
  ...
  {  // Add available package upgrade table
    LCH_TableCreateInfo createInfo = {
        ...
        .read_locator = ".leech/patch.cache",
        .write_locator = ".leech/patch.csv",
        .read_callback = LCH_TableReadCallbackCSV,
        .write_callback = LCH_TableWriteCallbackCSV,
        .insert_callback = LCH_TableInsertCallbackCSV,
        .delete_callback = LCH_TableDeleteCallbackCSV,
